...
| ------- | ------------ | ------ | ----------------------------------------------------------------------------------------------------------------------------- |
| 1.0     | Jan 2026     | Claude | Initial PRD with sequential implementation plan                                                                               |
| 1.1     | Jan 31, 2026 | Claude | Added Set Operations Abstraction Layer, Roaring Bitmap support, Master Scenario Table, Terminology section                    |
| 1.2     | Feb 5, 2026  | Claude | Optimized implementation plan with buffers (7 weeks); Added resource planning, coordination strategy, Gantt chart; Formatting |
...
6. [Set Operations Abstraction Layer](#6-set-operations-abstraction-layer) _(NEW in v1.1)_
...
11. [Master Scenario Table](#11-master-scenario-table) _(NEW in v1.1)_
12. [Terminology: Outlier vs DQ Issue vs Fraud vs Anomaly](#12-terminology) _(NEW in v1.1)_
...
| Phase 3 | Week 3-4 | Theta Sketch implementation                     |
| Phase 4 | Week 5   | Frequent Itemset integration                    |
| Phase 5 | Week 5-6 | Output generation                               |
| Phase 6 | Week 6-7 | Set Operations Abstraction Layer                |
...
- Week 1 D1-2: Project structure, dataclasses (MDTConfig, MDTNode)
- Week 1 D3-4: Configuration validation
- Week 1 D5: Pre_filter parser, abstract interfaces
- Week 2 D1-2: RawFactTreeBuilder.\_load_data() and preprocessing
- Week 2 D3-4: Greedy feature selection (opt_level=1)
- Week 2 D5: Recursive tree building, interface contracts

#### Phase 2: OLAP Cube Implementation (Week 3)

- D1-2: OLAPCubeTreeBuilder.\_load_data()
- D3-4: Metric computation from aggregates
- D5: Test equivalence with Raw FACT

#### Phase 3: Theta Sketch Implementation (Week 3-4)

- W3 D1-2: Sketch interface and data structures (parallel with Phase 2)
- W3 D3-4: Sketch intersection operations
- W3 D5: SUM approximation via binned sketches
- W4 D1-3: ThetaSketchTreeBuilder implementation
- W4 D4-5: Integration testing and buffer

#### Phase 4: Frequent Itemset Integration (Week 5)

**Traditional FIS (Raw FACT/OLAP)**

- D1-2: Integrate FIS library
- D3: Min_support retry logic and testing

**Union Coverage (Theta Sketch)**

- D1-2: Greedy union coverage selection
- D3: Absence itemset via De Morgan's law

**Shared**

- D4: Spine building from itemsets
- D5: Integration testing and buffer

#### Phase 5: Output Generation (Week 5-6)

**JSON and Text Tree**

- W5 D1-2: JSON serialization
- W5 D3: Text tree visualization
- W5 D4-5: Unit tests

**Graphviz and Plain English**

- W6 D1-2: Graphviz DOT format
- W6 D2-3: Plain English narrative generation
- W6 D4: Unit tests

**Integration**

- W6 D5: End-to-end testing, documentation

#### Phase 6: Set Operations Abstraction Layer (Week 6-7)

- W6 D3-5: SetOperationsProvider interface, AUTO selection logic (overlaps with Phase 5)
- W7 D1-2: ThetaSketchProvider implementation and unit tests
- W7 D3-4: RoaringBitmapProvider implementation and unit tests
- W7 D5: AUTO selection, finding classification, integration testing
...
| ------------------------------------ | --------------------------------------------------------------------- | ------------- |
| FIS library integration complexity   | Define abstract interface early; allow pluggable implementations      | Phase 1, 4    |
| Theta Sketch accuracy concerns       | Add accuracy metrics to output; document approximation bounds         | Phase 3, 6    |
| Performance with large trees         | Implement early termination; add progress logging                     | Phase 1, 2, 3 |
| Roaring Bitmap memory usage          | Add cardinality threshold warnings; recommend Theta for >100M records | Phase 6       |
| Provider selection confusion         | Implement AUTO mode with clear heuristics; document use cases         | Phase 6       |
| Parallel development merge conflicts | Daily sync; stagger merges; independent tests                         | Phase 2-6     |
| Interface contract drift             | Freeze interfaces in Phase 1 Week 2                                   | Phase 1       |
| Track integration issues             | Integration testing days; CI pipeline                                 | Phase 3-6     |
| Dependency blocking                  | Define minimal interfaces; allow stubs                                | Phase 2-5     |

### 13.5 Resources

| Phase   | Week | Developers | Assignment                      |
| ------- | ---- | ---------- | ------------------------------- |
| Phase 1 | 1-2  | 2-3        | Core infrastructure             |
| Phase 2 | 3    | 1-2        | OLAP Cube                       |
| Phase 3 | 3-4  | 1-2        | Theta Sketch                    |
| Phase 4 | 5    | 2          | Traditional FIS, Union Coverage |
| Phase 5 | 5-6  | 2          | JSON+Text, Graphviz+Narrative   |
| Phase 6 | 6-7  | 2          | Providers                       |

Minimum: 2 developers. Single developer: 9-10 weeks (sequential).

### 13.6 Coordination

- Daily standups
- Interface freeze: Phase 1 Week 2 Day 5
- Feature branches, staggered merges
...
Week 3:   Phase 2 - OLAP Cube
          Phase 3 - Theta Sketch (starts, parallel with Phase 2)
Week 4:   Phase 3 - Theta Sketch (continues with buffer)
Week 5:   Phase 4 - FIS Integration
          Phase 5 - Output Generation (starts)
Week 6:   Phase 5 - Output Generation (continues)
          Phase 6 - Set Operations (starts)
Week 7:   Phase 6 - Set Operations (completes with buffer)
```
...
### Epic 7: Set Operations Abstraction Layer _(NEW in v1.1)_
